...
const config = {
  ...
  organizationName: 'confixa-labs', // Usually your GitHub org/user name.
  projectName: 'confixa-documentation', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          // {
          //   href: 'https://github.com/confixa-labs/confixa-documentation',
          //   label: 'GitHub',
          //   position: 'right',
          // },
        ],
